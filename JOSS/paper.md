...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{fig/DecoupleFlow_Block.jpg}
\caption{DecoupleFlow Block containing an encoder, projector head, and local objective loss.}
\label{fig:block}
\end{figure}
```
